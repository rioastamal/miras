		...
		<div id="content">
			...
			<form class="miras" action="<?php echo ($data->post_url);?>" method="post">
				...
				<input class="text" type="password" name="password" value="" id="password" size="16" value="<?php echo (@$data->sess->password);?>" />
				<label class="label">Retype</label>
				<input class="text" type="password" name="password2" value="" id="password2" size="16" value="<?php echo (@$data->sess->password2);?>" />
